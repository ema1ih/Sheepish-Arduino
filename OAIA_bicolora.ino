...
int score, nrLives, nrLevel, levelPeriod, dontMoveTime = 0, currentTime, freezeStage = 0, buzzerStopTime;
...
void loop()
{
  ...
  if (buzzerStopTime > 0) buzzerStopTime --;
  ...
  if (stop == true) /// lcd-ul afiseaza un meniu
  {
    ...
    if (time > updateDisplayTime) displayMenu(); 
